...
public class SessionUtil
{
    ...
    /**
     * Clear all the keys in the session.
     * The MOBILE_SERVICES keys are the ones that start with the predefined MOBILE_SERVICES_.
     * @param request
     */
     ...
     * @return
     */
    public static HashMap<String, Object> fetchAll(HttpSession session)
    {
    ...
    /**
     * Internally  stores data in the following format
     * prefix + key
     * 
     * This is to distinguish between the normal session variables and the application session attributes
     * 
     * 
     * @param request
     * @param key
    ...
    {
	String internalKey = ApiConstants.MOBILE_SERVICES + key;
	return internalKey;
    }
